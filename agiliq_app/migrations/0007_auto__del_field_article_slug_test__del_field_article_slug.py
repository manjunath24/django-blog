...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.slug_test'
        db.delete_column(u'agiliq_app_article', 'slug_test')

        # Deleting field 'Article.slug'
        db.delete_column(u'agiliq_app_article', 'slug')


    def backwards(self, orm):
        # Adding field 'Article.slug_test'
        db.add_column(u'agiliq_app_article', 'slug_test',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Article.slug'
        db.add_column(u'agiliq_app_article', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True),
                      keep_default=False)
